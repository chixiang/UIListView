...
@interface UZUIRefreshTableHeaderView (Private)

@end

@implementation UZUIRefreshTableHeaderView
...
- (id)initWithFrame:(CGRect)frame  {
  return [self initWithFrame:frame arrowImageName:@"blueArrow.png" textColor:TEXT_COLOR withTips:@"下拉可刷新" showTime:YES];
}
...
- (void)setState:(EGOPullRefreshState)aState{
	...
	switch (aState) {
		case EGOOPullRefreshPulling:
            ...
            _statusLabel.text = self.textUp;//NSLocalizedString(@"Release to refresh...", @"Release to refresh status");
			[CATransaction begin];
		...
		case EGOOPullRefreshNormal:
            ...
            _statusLabel.text = self.textDown;//NSLocalizedString(@"Pull down to refresh...", @"Pull down to refresh status");
